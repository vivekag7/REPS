...
The HMTS method implemented in cbsREPS is based on the work of Ishaak, Ouwehand, and Remøy (2024), who developed a multilateral, time-series-based index that balances stability, limited revision, and early detection of turning points in the context of commercial property price indices (CPPIs) [@51c4602ed48c4adbb7b7d15176d2da7a].

For broader context and international guidelines on the compilation of residential property price indices, including traditional methods such as Laspeyres, Paasche, and Fisher, we refer to the Eurostat Handbook on RPPIs (2013) [@eurostat2013rppi].
