...
The `calculate_hedonic_index()` function is the central entry point in `REPS` for computing price indices using various **hedonic-based methods**. It also supports an unadjusted median-price benchmark for comparison:
...
* **Median** - unadjusted median transaction-price index for comparison
